...
class BeepForm(forms.ModelForm):
    body = forms.CharField(required=True,
                           widget=forms.widgets.Textarea(
                               attrs={
                                   "placeholder": "Enter Your Biz Beep!",
                                   "class": "form-control",
                               }
                           ),
                           label="",
...
class SignUpForm(UserCreationForm):
    ...
    profile_type = forms.ChoiceField(label="", choices=PROFILE_TYPE_CHOICES,
                                     widget=forms.Select(attrs={'class': 'form-control'}))
    investment_preference = forms.CharField(label="", max_length=100,
    ...
    class Meta:
        model = User
        fields = ('username', 'first_name', 'last_name', 'profile_type', 'investment_preference', 'email', 'password1',
                  'password2')
